...
const ExerciseCardRemove = (props: any) => {
  return (
        ...
        <div className="flex h-full items-center">
          ...
          <div className="flex flex-col md:justify-center ml-4">
            ...
            <button
              ...
              className="text-sm md:text-base lg:text-lg mt-4 w-43 bg-red-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue"
            >
              Remover do Workout
            </button>
          </div>
...
export default ExerciseCardRemove;
